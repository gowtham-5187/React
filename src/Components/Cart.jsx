...
const Cart = () => {
  ...
  useEffect(() => {
    if (userId) {
      axios.get(`https://ecommerce1-1-ryxo.onrender.com/api/cart?userId=${userId}`) //
...
const styles = {
  ...
  cartBox: { width: '100%', maxWidth: '500px', backgroundColor: 'white', padding: '30px', borderRadius: '15px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' },
